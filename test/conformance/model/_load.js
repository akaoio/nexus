 ...
 * Same Phase 0 pattern as the AST loader: until src/model/Model.js exists,
...
const NOT_IMPLEMENTED = () => {
    throw new Error("NOT_IMPLEMENTED: src/model/Model.js does not exist yet (Phase 0 — spec is red by design)")
}

let Model
try {
    Model = await import("../../../src/model/Model.js")
} catch {
    Model = new Proxy(
        {},
        {
