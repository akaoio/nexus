 ...
 *
 * Phase 0 (TDD): src/ast/AST.js does not exist yet. Instead of crashing the
...
const NOT_IMPLEMENTED = () => {
    throw new Error("NOT_IMPLEMENTED: src/ast/AST.js does not exist yet (Phase 0 — spec is red by design)")
}

let AST
try {
    AST = await import("../../../src/ast/AST.js")
} catch {
    AST = new Proxy(
        {},
        {
