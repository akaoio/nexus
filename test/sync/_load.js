 ...
 * until src/sync/Sync.js exists, every surface throws NOT_IMPLEMENTED so
...
const NOT_IMPLEMENTED = () => {
    throw new Error("NOT_IMPLEMENTED: src/sync/Sync.js does not exist yet (SYNC spec is red by design)")
}

let Sync
try {
    Sync = await import("../../src/sync/Sync.js")
} catch {
