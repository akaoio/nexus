 ...
 * system, embeds boot data, and loads the real app (src/studio/app.js),
 * which composes the modules. Everything of substance lives in files under
 * src/studio/ (ARCHITECTURE §7.1). This function just serves the shell.
 */
...
<link rel="stylesheet" href="/_nexus/src/studio/studio.css">
</head><body>
<script type="application/json" id="nx-boot">${JSON.stringify(boot)}</script>
<script type="module" src="/_nexus/src/studio/app.js"></script>
