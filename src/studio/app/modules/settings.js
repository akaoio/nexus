...
const fld = (label, input) => el("div", { class: "nx-field", style: "max-width:400px" }, [el("label", { class: "nx-label", text: label }), input])
...
export function render(ctx) {
    ...
    async function load() {
        ...
        const k = el("input", { class: "nx-input", placeholder: "dot.path e.g. site.locale", style: "max-width:220px" })
        const v = el("input", { class: "nx-input", placeholder: "value (JSON coerced)", style: "max-width:220px" })
        ...
        body.append(sec("Advanced", [el("div", { class: "nx-toolbar" }, [k, v, setb]), el("pre", { class: "nx-out", text: JSON.stringify(cfg, null, 2) })]))
    }
    load()
