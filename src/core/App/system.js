...
// fields gets a permlevel (as nexus_user.roles already has, line ~37), that
// route starts leaking it to permlevel-0 readers. Route and schema must move together.
